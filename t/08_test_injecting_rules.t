#################################################################
#
#   $Id: 08_test_injecting_rules.t,v 1.1 2007-05-16 15:07:44 erwan_lemonnier Exp $
#
...
use lib "../lib/";
use Hook::Filter rules => "some_impossible_file_that_should_not_exist", hook => ['mylog1','mylog2','mylog3'];
...
is(call_log1,1,"main::mylog1 ok");
is(call_log2,undef,"main::mylog2 skipped");
is(call_log3,1,"main::mylog3 ok");
...
is(call_log1,1,"main::mylog1 ok");
is(call_log2,undef,"main::mylog2 skipped");
is(call_log3,1,"main::mylog3 skipped");
